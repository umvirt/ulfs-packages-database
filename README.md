...
Based on: Linux From Scratch 12.2 (September 2024)

Status: Archived. Many packages are broken or missing. 
...
- Copy contents of this directory in tmp/0.2.2 directory

- Go to bin directory in ULFS Packages directory

- Import this database by running

        ./load_data --path=../tmp/0.2.2 --release=0.2.2 --format=xml
...
-  Mesa is made (open nVidia GPU's driver) "nouveau" unusable without Rust compiler 
